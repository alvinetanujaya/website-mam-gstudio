...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const sqlSchema = `-- ==========================================
-- OPSI 1: SATU TABEL 'products' DENGAN KOLOM CATEGORY (DIREKOMENDASIKAN)
-- ==========================================

-- 1. Tabel Produk / Menu Catering & Frozen Food
...
-- Jalankan jika tabel products sudah ada sebelumnya:
...
-- 4. Tabel Pengaturan Admin (PIN Terpusat)
...
-- ==========================================
-- OPSI 2: TABEL TERPISAH (makanan_utama & frozen_food)
-- ==========================================

-- Tabel 1: Makanan Utama
CREATE TABLE IF NOT EXISTS makanan_utama (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  name TEXT NOT NULL,
  price NUMERIC NOT NULL,
...
-- Tabel 2: Frozen Food
CREATE TABLE IF NOT EXISTS frozen_food (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  name TEXT NOT NULL,
  price NUMERIC NOT NULL,
  stock INT NOT NULL DEFAULT 50,
