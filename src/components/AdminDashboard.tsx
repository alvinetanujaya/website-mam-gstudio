...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const sqlSchema = `-- ==========================================
-- SKRIP HASIL REVISI LENGKAP SUPABASE (14 MENU UTAMA & FROZEN FOOD)
-- Mengatasi Error Foreign Key & Menghapus Menu Mingguan
-- ==========================================

-- 1. Lepas & Perbarui Relasi Foreign Key pada order_items agar bisa dihapus (ON DELETE SET NULL)
DO $$
BEGIN
...
-- 2. Bersihkan Item Menu Mingguan (ID 101-107) dari Supabase
DELETE FROM order_items WHERE product_id >= 100 AND product_id <= 200;
DELETE FROM products WHERE id >= 100 AND id <= 200 OR category = 'Menu Mingguan' OR name LIKE '[%';

-- 3. Pastikan Tabel 'products' Memiliki Kolom Lengkap
...
-- 4. Bersihkan Data Produk & Reset ID jika ingin isi ulang 14 menu utama
TRUNCATE TABLE products RESTART IDENTITY CASCADE;

-- 5. Insert 14 Menu Autentik Aplikasi (7 Makanan Utama & 7 Frozen Food)
